...
-- Q7.	Are there any patterns or trends in customer purchasing behaviour (e.g., frequency of purchases, preferred payment methods, 
-- average order value)? 
...
ALTER TABLE album
ADD COLUMN ReleaseYear INTEGER DEFAULT 2024;
select * from album;
